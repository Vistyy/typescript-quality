...
} from "../upstream/shared/function-parameters.ts";
...
function staticMethodName(callee: ESTree.Expression): string | null {
...
function isPromiseRejectionCallback(owner: ParameterOwner): boolean {
  ...
  if (call.callee.type === "Super" || call.callee.type === "V8IntrinsicExpression") return false;
...
export const noUnknownParametersRule = defineRule({
  meta: {
    ...
    docs: {
      description:
        "Disallow explicitly unknown function parameters except causes, type-predicate subjects, and Promise rejection callbacks.",
    },
    messages: {
      unknownParameter:
